...
title_list = ["all_genes","pcap1_DDGs","pcap20_DDGs","pcap80_DDGs"]
gene_list = [all_set, ddgsp1, ddgsp20, ddgsp80]
...
for cell_group, clabel in zip(data_list,cellname):
    ...
    for gene_group, glabel in zip(gene_list2, title_list2):
        ...
        venn2([set(gene_list[1]), set(gene_group)], set_labels=('DDGsp1', glabel))
        ax.set_rasterized(True)
        plt.savefig(large_root + "/" + label + clabel+ "gene_overlap_DDGp1_and_" + glabel + ".png")
        plt.savefig(large_root + "/" + label + clabel+ "gene_overlap_DDGp1_and_" + glabel + ".eps")
        fig.clear()
        ...
        ax = fig.add_subplot(111)
        ax.set_title(label + clabel + glabel + "overlap with DDGp1 set", fontsize=fs)
        ...
        ax.legend()
        plt.tight_layout()
        plt.savefig(large_root + "/" + label + glabel + clabel + "scatter_set_intersect_ddgp1_dispersion.png")
        plt.savefig(large_root + "/" + label + glabel + clabel + "scatter_set_intersect_ddgp1_dispersion.eps")
        fig.clear()
