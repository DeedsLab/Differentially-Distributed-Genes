...
HVG = pd.read_csv(r"/media/timothyhamilton/My Passport1/Tim_Hamilton/Zheng_FACS_pbmcs/zheng9_5k/HVGs.csv",nrows=1)
...
townes = pd.read_csv(r"/media/timothyhamilton/My Passport1/Tim_Hamilton/Zheng_FACS_pbmcs/zheng9_5k/zheng5k_dropzeros_townes.csv",index_col = 0,nrows=1)
