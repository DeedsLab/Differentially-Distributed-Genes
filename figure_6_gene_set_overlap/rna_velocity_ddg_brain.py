...
ddg_list = pd.read_csv(large_root + r"/dentategyrusDDG_data.csv", index_col=0, usecols=[0,1]) #gene x cells
...
topddg_frame.to_csv(large_root + "/dentategyrus_ddg_top300latenttime.csv")
