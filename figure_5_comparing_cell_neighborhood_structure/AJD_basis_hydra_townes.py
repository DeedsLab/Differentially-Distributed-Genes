...
large_root = r"/media/timothyhamilton/My Passport1/Tim_Hamilton/Hydra"
label = 'Hydra'
#AJD calc on cell by gene data
total_data = pd.read_csv(r"/media/timothyhamilton/My Passport1/Tim_Hamilton/Hydra/Hydra_full_Raw.csv", index_col=0) #cell x genes
HVG = pd.read_csv(r"/media/timothyhamilton/My Passport1/Tim_Hamilton/Hydra/Hydra_HVGs.csv", index_col=0) #c x g
DDG = pd.read_csv(r"/media/timothyhamilton/My Passport1/Tim_Hamilton/Hydra/Hydra_DDG_data.csv", index_col=0)# g x c
townes = pd.read_csv(r"/media/timothyhamilton/My Passport1/Tim_Hamilton/Hydra/Hydra_SCRY_Genes.csv", index_col=0)#c x g
mdrop = pd.read_csv(r"/media/timothyhamilton/My Passport1/Tim_Hamilton/Hydra/Hydra_M3Drop_Genes.csv", index_col=0)
nbdrop = pd.read_csv(r"/media/timothyhamilton/My Passport1/Tim_Hamilton/R01_Ref_Datasets/Hydra_Results/Hydra_NBUMIDrop_Genes.csv", index_col=0)
nbdisp = pd.read_csv(r"/media/timothyhamilton/My Passport1/Tim_Hamilton/R01_Ref_Datasets/Hydra_Results/Hydra_NBUMIDrop_Genes_High_Var.csv", index_col=0)
