...
townes = pd.read_csv("/home/breanne/sourcedata/Zheng9/zheng5k_dropzeros_townes.csv",index_col = 0,nrows=1)
...
countname = ['_raw_counts2_','_cpm_log_counts_']
