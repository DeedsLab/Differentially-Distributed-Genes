...
WC = pd.read_csv(r"/home/breanne/ddgs/cpmlog_zhengWC_8k.csv", index_col=0) #c x g
...
for data_group, cname in zip(data_list,countname):
    ...
    for glabel, gname in zip(gene_list,title_list):
        ...
        ax = plt.gca()
        plt.savefig(large_root + "/" + cname + "WCs_facs_tsne_plot.eps")
        plt.savefig(large_root + "/" + cname + "WCs_facs_tsne_plot.pdf")
