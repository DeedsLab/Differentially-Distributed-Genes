...
e10_5 = pd.read_csv(large_root + r"/zheng_5k100_newresamp_data_overlap_WC_5kbf8kg.csv", index_col=0)
e11 = pd.read_csv(large_root + r"/zheng_5k500_newresamp_data_overlap_WC_5kbf8kg.csv", index_col=0)
e12 = pd.read_csv(large_root + r"/zheng_5k1000_newresamp_data_overlap_WC_5kbf8kg.csv", index_col=0)
e13 = pd.read_csv(large_root + r"/zheng_5k2000_newresamp_data_overlap_WC_5kbf8kg.csv", index_col=0) #gene by cell
e13b = pd.read_csv(large_root + r"/zheng_5k3000_newresamp_data_overlap_WC_5kbf8kg.csv", index_col=0)
e13_5 = pd.read_csv(large_root + r"/zheng_5k4000_newresamp_data_overlap_WC_5kbf8kg.csv", index_col=0)
e14 = pd.read_csv(large_root + r"/zheng_5k5000_newresamp_data_overlap_WC_5kbf8kg.csv", index_col=0)
e15 = pd.read_csv(large_root + r"/zheng_5k6000_newresamp_data_overlap_WC_5kbf8kg.csv", index_col=0)
e16 = pd.read_csv(large_root + r"/zheng_5k7000_newresamp_data_overlap_WC_5kbf8kg.csv", index_col=0) #gene by cell
e17 = pd.read_csv(large_root + r"/zheng_5k8000_newresamp_data_overlap_WC_5kbf8kg.csv", index_col=0)
e18 = pd.read_csv(large_root + r"/zheng_5k9000_newresamp_data_overlap_WC_5kbf8kg.csv", index_col=0)
e19 = pd.read_csv(large_root + r"/zheng_5k10000_newresamp_data_overlap_WC_5kbf8kg.csv", index_col=0)
