...
label = 'hydra'
data = pd.read_csv(large_root + "/Hydra_full_Raw.csv", index_col=0) #must be transposed
pvals = pd.read_csv(large_root + "/hydra_whole24458_fast_Pvalues.csv",header = None, names = ["gene", "Pval"])
