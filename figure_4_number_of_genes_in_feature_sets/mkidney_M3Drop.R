...
library(dplyr)
library(data.table)
sub_folder<-"/media/timothyhamilton/My Passport1/Tim_Hamilton/Mouse_kidney/mkidney.csv"
...
fwrite(M3Drop_genes, file ="/media/timothyhamilton/My Passport1/Tim_Hamilton/Mouse_kidney/mkidney_M3Drop_Results.csv", row.names = TRUE)#
...
fwrite(gene_data, file ="/media/timothyhamilton/My Passport1/Tim_Hamilton/Mouse_kidney/mkidney_M3Drop.csv", row.names = TRUE)#
print(dim(gene_data))
