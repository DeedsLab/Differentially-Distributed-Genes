...
fwrite(M3Drop_genes, file ="/media/timothyhamilton/My Passport1/Tim_Hamilton/Planarian_atlas/planarian_M3Drop_Results.csv", row.names = TRUE)#
...
fwrite(gene_data, file ="/media/timothyhamilton/My Passport1/Tim_Hamilton/Planarian_atlas/planarian_M3Drop.csv", row.names = TRUE)#
print(dim(gene_data))
