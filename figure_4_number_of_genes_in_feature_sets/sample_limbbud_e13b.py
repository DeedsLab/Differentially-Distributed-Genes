...
droplist = filt.index[(filt['genes']<=4000) & (filt['counts']>27000)].tolist()
droplist1 = filt.index[(filt['genes']<=3300) & (filt['counts']>24000)].tolist()
droplist2 = filt.index[(filt['genes']<=2700) & (filt['counts']>20000)].tolist()
droplist3 = filt.index[(filt['genes']<=2200) & (filt['counts']>15000)].tolist()
droplist4 = filt.index[(filt['genes']<=1500) & (filt['counts']>8000)].tolist()
droplist5 = filt.index[(filt['genes']<=1200) & (filt['counts']>6000)].tolist()
droplist6 = filt.index[(filt['genes']<=600) & (filt['counts']>4000)].tolist()
droplist7 = filt.index[(filt['genes']<=400) & (filt['counts']>1500)].tolist()
