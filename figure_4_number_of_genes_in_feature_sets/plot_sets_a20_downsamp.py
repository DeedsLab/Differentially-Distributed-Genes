...
large_root = "/home/breannesparta/ddgs/A20_3T3"
print("Reading data...")
dnum = 1 #number of density graphs to print

p5data = pd.read_csv(large_root + r"/downsample/A20_3T3p05_newresamp_data_overlap_DDGp5.csv", index_col=0)
p9data = pd.read_csv(large_root + r"/downsample/A20_3T3p09_newresamp_data_overlap_DDGp5.csv", index_col=0)
allgenes = pd.read_csv(large_root + "/cellgene/A203T3pcap5DDG.csv", index_col=0, nrows=2)# c x g
print(allgenes.head())
allgenes = allgenes.T
...
ax.set_title("A20_3T3: DDG overlap in resampled data", fontsize=fs)
