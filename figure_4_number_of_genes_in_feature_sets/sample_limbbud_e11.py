...
droplist = filt.index[(filt['genes']<=5080) & (filt['counts']>31500)].tolist()
droplist1 = filt.index[(filt['genes']<=4350) & (filt['counts']>24000)].tolist()
droplist2 = filt.index[(filt['genes']<=3850) & (filt['counts']>20000)].tolist()
droplist3 = filt.index[(filt['genes']<=3400) & (filt['counts']>16000)].tolist()
droplist4 = filt.index[(filt['genes']<=3050) & (filt['counts']>14000)].tolist()
droplist5 = filt.index[(filt['genes']<=2800) & (filt['counts']>13000)].tolist()
droplist5 = filt.index[(filt['genes']<=2300) & (filt['counts']>10000)].tolist()
droplist6 = filt.index[(filt['genes']<=2100) & (filt['counts']>9000)].tolist()
droplist7 = filt.index[(filt['genes']<=1900) & (filt['counts']>7500)].tolist()
droplist8 = filt.index[(filt['genes']<=1400) & (filt['counts']>5000)].tolist()
droplist9 = filt.index[(filt['genes']<=1200) & (filt['counts']>4500)].tolist()
droplist10 = filt.index[(filt['genes']<=1000) & (filt['counts']>4000)].tolist()
droplist11 = filt.index[(filt['genes']<=850) & (filt['counts']>2800)].tolist()
...
for item in droplist7:
    droplist.append(item)
for item in droplist8:
    droplist.append(item)
for item in droplist9:
    droplist.append(item)
for item in droplist10:
    droplist.append(item)
for item in droplist11:
    droplist.append(item)
