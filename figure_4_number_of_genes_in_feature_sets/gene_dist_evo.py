...
large_root = "/media/timothyhamilton/data1/Tim_Hamilton/Evo_multicell"
print("Reading data...")
dnum = 1 #number of density graphs to print

label = 'trichoplax'
data = pd.read_csv(large_root + "/trichoplax.csv", index_col=0) #must be transposed
pvals = pd.read_csv(large_root + "/trichoplax_Pvalues.csv",header = None, names = ["gene", "Pval"])

#label = 'queenslandia'
#data = pd.read_csv(large_root + "/queenslandia.csv", index_col=0) #must be transposed
#pvals = pd.read_csv(large_root + "/queenslandia_Pvalues.csv", header = None, names = ["gene", "Pval"])

#label = 'comb_jelly'
#data = pd.read_csv(large_root + "/comb_jelly.csv", index_col=0) #must be transposed
#pvals = pd.read_csv(large_root + "/comb_jelly_Pvals.csv", header = None, names = ["gene", "Pval"])
