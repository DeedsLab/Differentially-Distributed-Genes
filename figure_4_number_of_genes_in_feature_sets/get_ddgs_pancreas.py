...
large_root = "/home/breannesparta/ddgs/dentategyrus/"
print("Reading data...")
dnum = 5 #number of density graphs to print
label = 'dentategyrus'
data2 = pd.read_csv(large_root+"/dentategyrus.csv", index_col=0) #must be transposed
pvals = pd.read_csv(large_root+"/dentate_pvals.txt", header = None, index_col=0, names = ["Pval"])
#data2 = data2.drop(columns=['Cell_Type'])
data2 = data2.T
