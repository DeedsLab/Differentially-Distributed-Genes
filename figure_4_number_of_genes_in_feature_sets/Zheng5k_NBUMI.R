...
fwrite(M3Drop_genes, file ="/media/timothyhamilton/data1/Tim_Hamilton/Zheng_FACS_pbmcs/zheng9_5k/zheng5k_dropzeros_NBUMI_Results.csv", row.names = TRUE)#
...
fwrite(gene_data, file ="/media/timothyhamilton/data1/Tim_Hamilton/Zheng_FACS_pbmcs/zheng9_5k/zheng5k_dropzeros_NBUMI.csv", row.names = TRUE)#
print(dim(gene_data))
