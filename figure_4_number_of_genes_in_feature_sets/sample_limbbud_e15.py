...
droplist = filt.index[(filt['genes']<=3000) & (filt['counts']>16000)].tolist()
droplist1 = filt.index[(filt['genes']<=2000) & (filt['counts']>9200)].tolist()
droplist4 = filt.index[(filt['genes']<=1800) & (filt['counts']>9000)].tolist()
droplist2 = filt.index[(filt['genes']<=1250) & (filt['counts']>7000)].tolist()
droplist3 = filt.index[(filt['genes']<=600) & (filt['counts']>3300)].tolist()
