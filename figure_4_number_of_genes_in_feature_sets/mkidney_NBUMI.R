...
fwrite(M3Drop_genes, file ="/media/timothyhamilton/My Passport1/Tim_Hamilton/Mouse_kidney/mkidney_NBUMI_Results.csv", row.names = TRUE)#
...
fwrite(gene_data, file ="/media/timothyhamilton/My Passport1/Tim_Hamilton/Mouse_kidney/mkidney_NBUMI.csv", row.names = TRUE)#
print(dim(gene_data))
