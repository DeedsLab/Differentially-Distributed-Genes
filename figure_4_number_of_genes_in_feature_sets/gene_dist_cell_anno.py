...
large_root = "/media/timothyhamilton/data1/Tim_Hamilton/Mouse_bladder"
print("Reading data...")
dnum = 15 #number of density graphs to print

#label = 'Macosko2015'
#data = pd.read_csv(r"C:\Users\bsparta\Desktop\data\DDG_paper\raw_data\Macosko2015.csv", index_col=0) #must be transposed
#pvals = pd.read_csv(r"C:\Users\bsparta\Desktop\data\DDG_paper\pvalues\Macosko2015_Pvals.csv", usecols=[1],header = None, names = ["Pval"])

#label = 'Svensson2017A_all'
#data = pd.read_csv(r"C:\Users\bsparta\Desktop\data\DDG_paper\raw_data\Svensson2017A.csv", index_col=0) #must be transposed
#pvals = pd.read_csv(r"C:\Users\bsparta\Desktop\data\DDG_paper\pvalues\Svensson2017A_Pvals.csv", usecols=[0,2], header = None, names = ["gene", "Pval"])

label = 'mouse_bladder'
data = pd.read_csv("/media/timothyhamilton/data1/Tim_Hamilton/Mouse_bladder/mouse_bladder.csv", index_col=0) #must be transposed
pvals = pd.read_csv("/media/timothyhamilton/data1/Tim_Hamilton/Mouse_bladder/mouse_bladder_Pvals.csv", header = None, names = ["gene", "Pval"])
...
#cellgroup1 = data.filter(regex='^b',axis=1) #b
...
DDG_list = data.drop(nonsig, 'index')
