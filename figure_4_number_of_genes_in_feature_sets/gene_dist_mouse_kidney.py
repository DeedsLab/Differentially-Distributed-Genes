...
large_root = "/home/breanne/sourcedata/mouse_kidney"
print("Reading data...")
...
label = 'mouse_kidney'
data = pd.read_csv("/home/breanne/sourcedata/mouse_kidney/mkidney.csv", index_col=0) #must be transposed
pvals = pd.read_csv("/home/breanne/sourcedata/mouse_kidney/mouse_kidney_Pvalues.csv", header = None, names = ["gene", "Pval"])
