...
droplist = filt.index[(filt['genes']<=5000) & (filt['counts']>33000)].tolist()
droplist1 = filt.index[(filt['genes']<=4700) & (filt['counts']>28000)].tolist()
droplist2 = filt.index[(filt['genes']<=4000) & (filt['counts']>20500)].tolist()
droplist3 = filt.index[(filt['genes']<=2800) & (filt['counts']>12500)].tolist()
droplist4 = filt.index[(filt['genes']<=2300) & (filt['counts']>8500)].tolist()
droplist5 = filt.index[(filt['genes']<=1700) & (filt['counts']>6500)].tolist()
droplist6 = filt.index[(filt['genes']<=1400) & (filt['counts']>4500)].tolist()
droplist7 = filt.index[(filt['genes']<=1200) & (filt['counts']>4000)].tolist()
droplist8 = filt.index[(filt['genes']<=900) & (filt['counts']>2500)].tolist()
droplist9 = filt.index[(filt['genes']<=700) & (filt['counts']>1800)].tolist()
