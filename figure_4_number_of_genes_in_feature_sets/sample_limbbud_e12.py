...
droplist = filt.index[(filt['genes']<=3150) & (filt['counts']>18000)].tolist()
droplist1 = filt.index[(filt['genes']<=2000) & (filt['counts']>12000)].tolist()
droplist2 = filt.index[(filt['genes']<=1800) & (filt['counts']>10000)].tolist()
droplist3 = filt.index[(filt['genes']<=1100) & (filt['counts']>3000)].tolist()
droplist4 = filt.index[(filt['genes']<=700) & (filt['counts']>2000)].tolist()
