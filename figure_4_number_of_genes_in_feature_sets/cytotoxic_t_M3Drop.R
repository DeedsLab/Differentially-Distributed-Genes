...
library(dplyr)
library(data.table)
sub_folder<-"/media/timothyhamilton/My Passport1/Tim_Hamilton/Zheng_FACS_pbmcs/cytotoxic_t.csv"
...
fwrite(M3Drop_genes, file ="/media/timothyhamilton/My Passport1/Tim_Hamilton/Zheng_FACS_pbmcs/cytotoxic_T_M3Drop_Results.csv", row.names = TRUE)#
...
fwrite(gene_data, file ="/media/timothyhamilton/My Passport1/Tim_Hamilton/Zheng_FACS_pbmcs/cytotoxic_T_M3Drop.csv", row.names = TRUE)#
print(dim(gene_data))
