...
large_root = "/media/timothyhamilton/data1/Tim_Hamilton/BabyMouse_kidney"
print("Reading data...")
dnum = 5 #number of density graphs to print

label = 'planarin'
data2 = pd.read_csv("/media/timothyhamilton/data1/Tim_Hamilton/BabyMouse_kidney/planarian_dropzeros.csv", index_col=0) #must be transposed
pvals = pd.read_csv("/media/timothyhamilton/data1/Tim_Hamilton/BabyMouse_kidney/planarian_Pvalues.csv", header = None, names = ["gene", "Pval"])
