...
large_root = r"/home/breanne/sourcedata/Zheng9/pval_recalc/"
print("Reading data...")
dnum = 1 #number of density graphs to print

label = 'zheng10k'
data2 = pd.read_csv("/home/breanne/sourcedata/Zheng9/zheng5k_dropzeros.csv", index_col=0) #must be transposed
pvals = pd.read_csv("/home/breanne/sourcedata/Zheng9/zheng5k_dropzeros.tx.csv", header = None, names = ["gene", "Pval"])
