...
droplist = filt.index[(filt['genes']<=2300) & (filt['counts']>12000)].tolist()
droplist1 = filt.index[(filt['genes']<=1850) & (filt['counts']>8100)].tolist()
droplist2 = filt.index[(filt['genes']<=1050) & (filt['counts']>4200)].tolist()
droplist3 = filt.index[(filt['genes']<=600) & (filt['counts']>2500)].tolist()
droplist4 = filt.index[(filt['genes']<=500) & (filt['counts']>1500)].tolist()
