...
large_root = r"/media/timothyhamilton/My Passport1/Tim_Hamilton/Mouse_bladder"
print("Reading data...")
dnum = 5 #number of density graphs to print

label = 'baby_mouse_kidney'
data2 = pd.read_csv(r"/media/timothyhamilton/My Passport1/Tim_Hamilton/Mouse_bladder/mouse_bladder.csv", index_col=0) #must be transposed
pvals = pd.read_csv(r"/media/timothyhamilton/My Passport1/Tim_Hamilton/Mouse_bladder/mouse_bladder_Pvals.csv", header = None, names = ["gene", "Pval"])

#data2 = data2.T
#doesnt match did I drop zeros in making mouse bladder
...
DDG_list = data2.drop(nonsig, 'index')
