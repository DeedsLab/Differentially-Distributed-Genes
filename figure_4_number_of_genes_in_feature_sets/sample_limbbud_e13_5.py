...
droplist = filt.index[(filt['genes']<=6000) & (filt['counts']>37000)].tolist()
droplist1 = filt.index[(filt['genes']<=4900) & (filt['counts']>30000)].tolist()
droplist2 = filt.index[(filt['genes']<=4250) & (filt['counts']>29000)].tolist()
droplist3 = filt.index[(filt['genes']<=4150) & (filt['counts']>24000)].tolist()
droplist4 = filt.index[(filt['genes']<=3000) & (filt['counts']>19000)].tolist()
droplist5 = filt.index[(filt['genes']<=2400) & (filt['counts']>15000)].tolist()
droplist6 = filt.index[(filt['genes']<=1800) & (filt['counts']>10000)].tolist()
droplist7 = filt.index[(filt['genes']<=1200) & (filt['counts']>6000)].tolist()
droplist8 = filt.index[(filt['genes']<=500) & (filt['counts']>2000)].tolist()
