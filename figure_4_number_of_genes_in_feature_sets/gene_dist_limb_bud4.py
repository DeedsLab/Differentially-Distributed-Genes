...
#label = 'e15_limbbud'
#data = pd.read_csv(large_root + "/e15_limbbud.csv", index_col=0) #must be transposed
#pvals = pd.read_csv(large_root + "/e15_pvals.csv",header = None, names = ["gene", "Pval"])

label = 'e13_5_limbbud'
data = pd.read_csv(large_root + "/e13_5_limbbud.csv", index_col=0) #must be transposed
pvals = pd.read_csv(large_root + "/e13_5_pvals.csv",header = None, names = ["gene", "Pval"])
